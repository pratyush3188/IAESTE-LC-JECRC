...
class InfiniteGridMenu {
    ...
    #updateProjectionMatrix(gl) {
        ...
        const height = this.SPHERE_RADIUS * 0.25;
...
export default function InfiniteMenu({ items = [] }) {
    ...
    return (
        ...
        >
            ...
            <div className="absolute w-[520px] h-[520px] rounded-full blur-3xl bg-gradient-to-tr from-[#003F68]/10 to-[#00A8E8]/10 animate-pulse" />
        ...
        `}
                >
                    <span className="bg-gradient-to-r from-[#003F68] to-[#00A8E8] bg-clip-text text-transparent">
                        {activeItem?.title || 'Explore Events'}
                    </span>
                </h1>

                <p
                    className={`
          mt-2 text-gray-500 text-sm md:text-base
        ...
        `}
            ...
            {/* Infinite Menu Canvas (scaled, not wrapped) */}
            <canvas
      ...
      "
          ...
          `}
            ...
            bg-[#00ffff] border-[5px] border-black
