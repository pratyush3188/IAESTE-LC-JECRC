  ...
  return (
    <>
      <article
        ...
        className={`bg-white rounded-lg shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden cursor-${member.bio ? 'pointer' : 'default'} transform hover:-translate-y-2 focus:outline-none focus:ring-2 focus:ring-[#003F68] focus:ring-offset-2 flex flex-col h-full`}
      ...
      >
        ...
        <div className="bg-gradient-to-r from-[#003F68] to-[#005a8f] text-white p-4 flex-1 flex flex-col justify-center items-center text-center">
